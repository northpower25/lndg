...
- **Default password:** shown in the dialog (generated by Umbrel for this app)

If installation fails during startup on Umbrel, check:
- `/home/umbrel/umbrel/app-data/northpower25-lndg/data/lndg-init.log` (initialize step)
- `/home/umbrel/umbrel/app-data/northpower25-lndg/data/lndg-controller.log` (runtime server log)
