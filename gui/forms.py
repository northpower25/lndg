...
class NotificationSettingsForm(forms.Form):
    ...
    nostr_enabled = forms.BooleanField(required=False, label='NOSTR Enabled')
    nostr_privkey = forms.CharField(required=False, max_length=64, label='NOSTR Private Key (hex)')
    nostr_relays = forms.CharField(required=False, label='NOSTR Relays (comma-separated)')
