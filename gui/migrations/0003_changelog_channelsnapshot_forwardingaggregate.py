    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_channel_id', models.CharField(blank=True, db_index=True, default='', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                'app_label': 'gui',
                'indexes': [models.Index(fields=['channel_id', 'timestamp'], name='gui_channel_channel_2ceb07_idx')],
            },
        ),
        migrations.CreateModel(
