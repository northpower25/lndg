...
def notification_settings(request):
    ...
    if request.method == 'POST':
        ...
        cfg.mempool_enabled = _bool('mempool_enabled')
        cfg.amboss_enabled = _bool('amboss_enabled')
        cfg.amboss_api_key = request.POST.get('amboss_api_key', '').strip()
        ...
        cfg.notify_mempool_low_fee = _bool('notify_mempool_low_fee')
        cfg.save()
